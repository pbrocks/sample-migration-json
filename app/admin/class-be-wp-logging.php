 ...
 * Admin Dashboard
 *
 * @package Phoenix\Logs\Admin
 */

namespace Phoenix\Logs\Admin;

use Phoenix\Logs\Includes;
...
class BE_WP_Logging {
	...
	function __construct() {
		...
		// create admin menu
		add_action( 'admin_menu', array( $this, 'wp_logging_settings' ) );
	...
	public function register_post_type() {
		...
		$log_args = array(
			'labels'          => array( 'name' => __( 'Backend Logs', 'wp-logging' ) ),
...
$GLOBALS['be_wp_logs'] = new BE_WP_Logging();
